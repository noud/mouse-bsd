/*	$NetBSD: refclock_acts.c,v 1.3 1998/03/06 18:17:22 christos Exp $	*/
...
#if defined(ACTS) && defined(PTBACTS)
...
#else /* not (REFCLOCK && (ACTS || PTBACTS)) */
int refclock_acts_bs;
#endif /* not (REFCLOCK && (ACTS || PTBACTS)) */
