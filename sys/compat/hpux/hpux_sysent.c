...
struct sysent hpux_sysent[] = {
	...
	{ 4, s(struct hpux_sys_osemctl_args),
	    hpux_sys_osemctl },			/* 157 = osemctl */
	...
	{ 3, s(struct hpux_sys_omsgctl_args),
	    hpux_sys_omsgctl },			/* 160 = omsgctl */
	...
	{ 3, s(struct hpux_sys_oshmctl_args),
	    hpux_sys_oshmctl },			/* 164 = oshmctl */
...
#ifdef SYSVSEM
	{ 4, s(struct hpux_sys_semctl_args),
	    hpux_sys_semctl },			/* 312 = semctl */
#else
	{ 0, 0,
	    sys_nosys },			/* 312 = unimplemented semctl */
#endif
#ifdef SYSVMSG
	{ 3, s(struct hpux_sys_msgctl_args),
	    hpux_sys_msgctl },			/* 313 = msgctl */
#else
	{ 0, 0,
